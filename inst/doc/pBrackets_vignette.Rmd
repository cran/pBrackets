---
title:  "Some examples and explanations for pBrackets."
author: "Andreas Schulz"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Some examples and explanations for pBrackets.}
...
The graphics are actually self-explanatory. For basic R graphics use `brackets` function.
For grid based graphics (ggplot2) use the `grid.brackets` function.



## Different kinds of brackets

```{r, echo=FALSE, results='asis', fig.height = 7, fig.width = 7,  fig.cap = 'Get a specific bracket with use of different arguments.'}
par(mar=c(1,1,1,1))
...
## Direction of brackets


```{r, echo=FALSE, results='asis', fig.height = 7, fig.width = 7, fig.cap = 'Two ways to change direction of brackets.'}
par(mar=c(1,1,1,1))
...
```{r, echo=FALSE, results='asis', fig.height = 7, fig.width = 7, fig.cap = 'Different kinds of ticks and brackets without ticks.'}
...
```{r, echo=FALSE, results='asis', fig.height = 7, fig.width = 7, fig.cap = 'Curvature argument with different types of brackets.'}
