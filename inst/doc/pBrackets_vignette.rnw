...
\title{Some examples and explanations for pBrackets.}
...
\begin{document}
\SweaveOpts{engine=R}
%\VignetteIndexEntry{Adds different kinds of brackets to a plot.}
%\VignetteKeywords{brackets, braces}
%\VignettePackage{pBrackets}
...
%===============================================================================
<<label=plot1, fig=TRUE, height=8, width=8, echo=FALSE, include=FALSE, pdf=FALSE, png=TRUE, resolution=150>>=
...
%===============================================================================
<<label=plot2, fig=TRUE, height=8, width=8, echo=FALSE, include=FALSE, pdf=FALSE, png=TRUE, resolution=150>>=
...
%===============================================================================
<<label=plot3, fig=TRUE, height=8, width=8, echo=FALSE, include=FALSE, pdf=FALSE, png=TRUE, resolution=150>>=
...
%===============================================================================
<<label=plot4, fig=TRUE, height=7, width=8, echo=FALSE, include=FALSE, pdf=FALSE, png=TRUE, resolution=150>>=
...
%###############################################################################
%===============================================================================
\section{Different kinds of brackets}

\begin{figure}[tbh]
\setkeys{Gin}{width=1\textwidth}
\begin{center}
\includegraphics{pBrackets_vignette-plot1.png}
\end{center}
\label{plot1}
\caption{Get a specific bracket with use of different arguments.}
\end{figure}
\newpage
%===============================================================================
%###############################################################################
...
%###############################################################################
%===============================================================================
\section{Direction of brackets}

\begin{figure}[tbh]
\setkeys{Gin}{width=1\textwidth}
\begin{center}
\includegraphics{pBrackets_vignette-plot2.png}
\end{center}
\label{plot2}
\caption{Two ways to change direction of brackets.}
\end{figure}
\newpage
%===============================================================================
%###############################################################################
...
%###############################################################################
%===============================================================================
\section{Set ticks argument}


\begin{figure}[tbh]
\setkeys{Gin}{width=1\textwidth}
\begin{center}
\includegraphics{pBrackets_vignette-plot3.png}
\end{center}
\label{plot3}
\caption{Different kinds of ticks and brackets without ticks.}
\end{figure}
\newpage
%%%%%%%%%%%%%%%%%%%
%                 %
...
%###############################################################################
%===============================================================================
\section{Curvature argument}


\begin{figure}[tbh]
\setkeys{Gin}{width=1\textwidth}
\begin{center}
\includegraphics{pBrackets_vignette-plot4.png}
\end{center}
\label{plot4}
\caption{Curvature argument with different types of brackets.}
\end{figure}
